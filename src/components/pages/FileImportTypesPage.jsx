...
export default function FileImportTypesPage() {
  ...
  const filteredTypes = useMemo(() => {
    ...
    return fileImportTypes.filter((item) => {
      const values = [
        item.fileType,
        item.parserType,
        item.delimiter,
      ...
      <PageContainer className="space-y-6">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage file import types per hotel.</p>
          </div>
          <button
        ...
        <div>
          ...
          <input
            ...
            placeholder="Search by file type, parser, collection, write mode or state"
