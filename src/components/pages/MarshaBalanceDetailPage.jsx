...
export default function MarshaBalanceDetailPage() {
  ...
  const mappingColumns = [
    ...
    { key: "values", label: "Values", sortable: false, render: (calculation) => calculation.applicable === false ? "Condition not met" : calculation.assessable ? <span>{calculation.marshaValue} MARSHA / {calculation.operaValue} Opera{calculation.reservedRooms ? ` − ${calculation.reservedRooms} reserved` : ""}</span> : "Required value missing" },
