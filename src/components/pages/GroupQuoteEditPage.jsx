...
export default function GroupQuoteEditPage() {
  ...
  return <div className="min-h-screen bg-gray-50 text-gray-900">
    ...
    <PageContainer className="space-y-6 pb-10">
      ...
      {loading ? <p className="text-gray-600">Loading quote...</p> : !quote ? <Card>Group quote not found.</Card> : <Card><GroupQuoteFormFields initialQuote={quote} defaultGroupCommissionPercentage={quoteSettings.defaultGroupCommissionPercentage} defaultGroupMealBasis={quoteSettings.defaultGroupMealBasis || "RO"} onSubmit={handleUpdate} saving={saving} submitLabel="Save Quote" /></Card>}
    </PageContainer>
  </div>;
}
