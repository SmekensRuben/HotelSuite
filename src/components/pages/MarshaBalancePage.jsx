...
const emptyRule = () => ({ id: crypto.randomUUID(), ruleScope: "rooms", marshaRoomType: "", operaRoomTypes: [], comparisonMode: "exact", reservedRooms: 0, allowedDeviation: 0, lowerDeviation: 0, upperDeviation: 0, activationCondition: "always", activationSource: "marsha", activationThreshold: 0, enabled: false });
