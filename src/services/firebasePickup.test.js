...
import { aggregatePickupRows, listSnapshotDateCandidates } from "./firebasePickup";

describe("listSnapshotDateCandidates", () => {
  it("returns today first and then walks backwards", () => {
    expect(listSnapshotDateCandidates(new Date("2026-03-22T10:00:00Z"), 3)).toEqual([
      "2026-03-22",
      "2026-03-21",
      "2026-03-20",
      "2026-03-19",
